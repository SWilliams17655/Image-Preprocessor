Image-processor is an image processing tool which includes a library of common image preprocessing functions. This includes edge detection, segmentation, corner detection, and optical flow to name a few. 
